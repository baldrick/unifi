...
* `--ignore_group` to specify a group to ignore; e.g. suppose you have hundreds of friends but don't want to sync all of them with Unifi Talk, add another label to the contacts not to sync and specify that label here (I used `NoSync`) 
